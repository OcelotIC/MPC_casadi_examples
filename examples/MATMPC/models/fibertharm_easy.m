...
H1 = diag([0.00005, 0.000011, 0.00004]);
H2 = diag([0.00035, 0.002   , 0.0016]);
H3 = diag([4.23e-5, 1.41e-4 , 1.19e-4]);
...
m_arm = [0.06 0.256 0.093]; %masses of arm bodies
for i = 0 : robot.n
