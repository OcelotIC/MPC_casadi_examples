...
/* path_con_fun:(states[20],controls[4],params[0])->(general_con[]) */
...
void mex_path_con_fun(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  if (--argc>=0) arg[1] = casadi_from_mex(argv[1], w+20, casadi_s1, w+24);
  if (--argc>=0) arg[2] = casadi_from_mex(argv[2], w+24, casadi_s2, w+24);
  casadi_real* res[1] = {0};
  --resc;
  res[0] = w+24;
  i = path_con_fun(arg, res, iw, w+24, 0);
