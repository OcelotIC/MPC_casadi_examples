...
%settings.model='RNE_fibertharm_simple'; % see the folder "examples" for details
settings.model='Space_Robot_example'; % see the folder "examples" for details

run(settings.model);

%%changer chemin casadi
...
if strcmp(settings.model, 'tilthex') == false
    settings.nu_m = nu_m;
end 
cd data
