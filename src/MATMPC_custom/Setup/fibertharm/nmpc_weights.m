...
weights.q_angle    = [ 20       20    20   ];
weights.q_dangle   = [ 1       1       1       ];
weights.q_acc      = [ 1e-4    1e-4    1e-4    ];
weights.q_aacc     = [ 1e-2    1e-2    1e-2   ];
weights.q_ddangle  = [ .1    .1   .1   ];
%% Collect weights
weights.q = [ weights.q_pos    weights.q_vel  ...
              weights.q_att    weights.q_avel ...   
              weights.q_angle  weights.q_dangle ...
